...
1. `CalibreQuarry` (PyPI floor `vir-tui>=2.3.0`)
2. `lattice-music` (PyPI floor `vir-tui>=2.3.0`)
3. `bindery-cli` (PyPI floor `vir-tui>=2.3.0`; the old exact-commit pin policy was retired for ranges)
